...
export class TasksController {
  ...
  @UseGuards(JwtGuard)
  @ApiBody({ schema: { type: 'object', properties: { title: { type: 'string' }, state: { type: 'string' }, description: { type: 'string' } } } })
  @Post(":userId")
  async add(@Param("userId") userId: string, @Body() body: Omit<ITask, "createdAt" | "updatedAt">) {
